...
namespace UnitTests
{
   ...
   public class RuleEngineUnitTest : TestBed<TestFixture>
   {
      ...
      public async Task CSharpScriptEvaluateTest1()
      {
         ...
         var result1 = await CSharpScript.EvaluateAsync(sourceCode, scriptOptions);
         Assert.True(result1.ToString() == "#FFFFFF");
      ...
      public async Task CSharpScriptEvaluateTest2()
      {
         ...
         var result1 = await CSharpScript.EvaluateAsync<string>(sourceCode, scriptOptions);
      ...
      public async Task CSharpScriptDataExchangeTest1()
      {
         ...
         {
            await script.RunAsync(modifyByScript);
         }
      }
      ...
      public async Task CSharpScriptDataExchangeTest2()
      {
         ...
         var scriptState = await script.RunAsync(scriptDataIn);
      ...
      public async Task CSharpScriptDataExchangeTest3()
      {
         ...
         string sourceCode = await File.ReadAllTextAsync("CSharpScriptHeatmap.csx");
         var script = CSharpScript.Create<string>(sourceCode,
             scriptOptions,
             typeof(ScriptDataIn));
      ...
      public async Task CSharpScriptEvaluateTest12()
      {
         ...
         while (modifyByScript.IndexLed != 0)
         {
            var scriptState = await script.RunAsync(modifyByScript);
      ...
      public async Task CSharpScriptEvaluateTest12A()
      {
        ...
        ";
         ...
         var result = await CSharpScript.EvaluateAsync(sourceCode);
