...
namespace IotZoo
{
        ...
        : DeviceBase(deviceIndex, settings, mqttClient, baseTopic)
    {
        ...
        Serial.println("TrafficLight instantiated with pinRed: " + String(this->pinRedLed) + ", pinYellow: " + String(this->pinYellowLed) +
                       ", pinGreen: " + String(this->pinGreenLed));
    }

    TrafficLight::~TrafficLight()
    {
        Serial.println("Destructor TrafficLight with pinRed: " + String(this->pinRedLed) + ", pinYellow: " + String(this->pinYellowLed) +
                       ", pinGreen: " + String(this->pinGreenLed));
    }
    ...
    void TrafficLight::onMqttConnectionEstablished()
    {
        ...
        mqttClient->subscribe(topicTrafficLightLeds, [&](const String& payload) { handleTrafficLightPayload(payload); });
    }
} // namespace IotZoo
